    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f_customrendertexture IN) : COLOR
            {
                ...
                int neightbor=int(get(IN,-1,-1).a+get(IN,0,-1).a+get(IN,1,-1).a+get(IN,-1,0).a+get(IN,1,0).a+get(IN,-1,1).a+get(IN,0,1).a+get(IN,1,1).a);
                if(self>0.5){

                if(neightbor<2)
                    return float4(0,0,0,0);
                else if(neightbor==2||neightbor==3)
                    return float4(1,1,1,1);
                else 
                    return float4(0,0,0,0);

                }
                else if(self<=0.5 && neightbor==3){
                    return float4(1,1,1,1);
                }
                else
                    return float4(0,0,0,0);
